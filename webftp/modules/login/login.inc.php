...
// ------------------------------------
	...
	if ($net2ftp_settings["allowed_ftpserverport"] == "ALL") {
		...
		if ($net2ftp_globals["ftpserverport"] != "") { 
			$ftpserverport["defaultvalue"]     = htmlEncode2($net2ftp_globals["ftpserverport"]); 
		...
		elseif ($net2ftp_globals["cookie_ftpserverport"] != "") { 
			$ftpserverport["defaultvalue"]     = htmlEncode2($net2ftp_globals["cookie_ftpserverport"]); 
			$ftpserverport["defaultvalue_ftp"] = htmlEncode2($net2ftp_globals["cookie_ftpserverport_ftp"]); 
			$ftpserverport["defaultvalue_ssh"] = htmlEncode2($net2ftp_globals["cookie_ftpserverport_ssh"]); 
			$ftpserverport["defaultvalue_ssl"] = htmlEncode2($net2ftp_globals["cookie_ftpserverport_ssl"]); 
		}

		// Else
		// For FTP, fill in default port 21
		// For SSH, fill in default port 22
		else { 
			$ftpserverport["defaultvalue_ftp"] = 21; 
			$ftpserverport["defaultvalue_ssh"] = 22; 
			$ftpserverport["defaultvalue_ssl"] = 990;
		}
	}
	
	else {
		$ftpserverport["inputType"] = "hidden";
		$ftpserverport["defaultvalue"]     = $net2ftp_settings["allowed_ftpserverport"];
