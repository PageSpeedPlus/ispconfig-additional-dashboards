...
<?php		if ($ftpserver["inputType"] == "text") { ?>
			...
			<input type="text" name="ftpserver" value="<?php echo $ftpserver["list"][1]; ?>" autocorrect="off" autocapitalize="off" style="width: 80%;" />
	 		<input type="text" size="4" maxlength="5" name="ftpserverport" value="<?php echo $ftpserverport["defaultvalue"]; ?>" autocorrect="off" autocapitalize="off" />
...
<?php			for ($i=1; $i<=sizeof($protocol["list"]); $i++) {
				$selected = "";
