...
<?php printLoginInfo(); ?>
	...
	<div class="page">
		<input type="text" style="width: 97%;" name="directory" value="<?php echo $directory_html; ?>" autocorrect="off" autocapitalize="off" /><br />
			<select name="BrowseSelect" onchange="eval(document.BrowseForm.BrowseSelect.options[document.BrowseForm.BrowseSelect.selectedIndex].value);" style="width: 99%; margin-bottom: 10px;">
